...
<div class="card card-cyan">
    ...
    if(isset($error)){
        ...
        echo form_open_multipart('Employee/Edit/' . $employee->id_employee)?>
        <div class="row">
          <div class="col-md-6">
            <!-- text input -->
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label>Wilayah</label>
                ...
                <option value="<?=$employee->id_wilayah?>"><?=$employee->nama_wilayah?></option>
                  <?php 
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="role" class="form-control">
                <?php $role = $this->input->post('role') ? $this->input->post('role') : $employee-> role?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form_group">
              ...
              <a href="<?=base_url('Employee/ganti_password/' . $employee->id_employee)?>" class="btn btn-success btn-xl">Ganti Password</a>
