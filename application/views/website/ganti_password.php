...
<div class="card card-cyan">
    ...
    <h3 class="card-title">Form Ganti Password <?=$user->nama_user?></h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
    <?php
    ...
    if(isset($error)){
        ...
        echo form_open('website/ganti_password/' . $user->id_user)?>
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          ...
          <div class="form_group">
              ...
              <a href="<?=base_url('website/akun/' . $user->id_user )?>" class="btn btn-default btn-xl">Close</a>
          </div>
    <?php echo form_close()?>    
    </div>
</div>
