    ...
    <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td class="text-center">
            <a href="<?=base_url('Proses/view/' . $value->id_syarat)?>" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>
...
<?php foreach ($syarat as $key => $value){?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-footer justify-content-between">
            ...
            <a href="<?=base_url('proses/delete/' . $value->id_syarat)?>" class="btn btn-primary">Delete  </a>
        </div>
        </div>
        <!-- /.modal-content -->
    </div>
